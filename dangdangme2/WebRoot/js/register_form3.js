		...
		$("#txtNickName").blur(function() {
			...
			$("#name\\.info").html("");//清空
				if (nickname == "") {//非空检查 
					...
					//alert("VVVV");
					//var patt = /^([\u4E00-\u9FA5]|[a-z0-9]{2}){4,20}$/; 
					//var patt =/^[a-zA-Z][a-zA-Z0-9_]{4,20}$/;//字母开头，允许4-20字节，允许字母数字下划线
					var patt =/^([\u4E00-\u9FA5]|[a-zA-Z0-9]){4,20}$/;
	...
	$(function() {
		$("#f").submit(function() {
			$("#txtEmail").blur();//触发email检查
				...
				return checkflag.email&&checkflag.nickname&&checkflag.password;
