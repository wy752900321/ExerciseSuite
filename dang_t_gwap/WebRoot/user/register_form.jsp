...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/register_form.js">
</script>
	</head>
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="register.action" id="f">
						...
						<td>
							...
							<div class="text_left t1">
								<p class="t1">
									...
									<br />
									<a title="点击更换图片" href="javascript:;"
										onclick="document.getElementById('imgVcode').src = 'imagecode.action?dt='+ new Date().getTime()">看不清楚？换个图片</a>
				...
				<div class="login_in">
					<input style="height: 30px; width: 80px; font-size: 18px;"
