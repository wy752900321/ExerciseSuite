		...
		.extend(
				...
				(function() {
					...
					function destroyWrapper(id, eventName, handler) {
						...
						if (!c[eventName])
							return false;
						c[eventName] = c[eventName].without(findWrapper(id,
								eventName, handler));
					}
					...
					return {
						observe : function(element, eventName, handler) {
							...
							var wrapper = createWrapper(element, eventName,
									handler);
							if (!wrapper)
								return element;
						...
						stopObserving : function(element, eventName, handler) {
							...
							if (!handler && eventName) {
								getWrappersForEventName(id, eventName).each(
										function(wrapper) {
								...
								Object.keys(getCacheForID(id)).each(
										function(eventName) {
											element.stopObserving(eventName);
										});
								return element;
