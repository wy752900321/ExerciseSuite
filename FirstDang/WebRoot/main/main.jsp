...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" 
		...
		<script type="text/javascript">
		 $(function(){
		// $("#new").load("findNew.action",{"size":8});
		 //$("#hot").load("hot.action",{"size":4});
		 $("#new12").load("newhot.action",{"size":8});
		 });
	...
	<body>
		...
		<div class="book">
			...
			<div class="book_center">
				...
				<s:action name="findNew" executeResult="true" namespace="/main"></s:action>
				...
				<div class="book_r_border2" id="__XinShuReMai">
					<div class="book_r_b2_1x" id="new_bang">
						...
						<div id="NewProduct_1_o_t" onmouseover="">
							<h3 class="second">
								<s:action name="maxCount" namespace="/main" executeResult="true"></s:action>
