...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/hotSaleColumn.js"></script>
	...
	<body onload="hotSale();">
		...
		<div class="book">
			...
			<img src="../images/window_loading.gif"/>
				正在加载数据，稍等！
				<%--
			...
			<div class="book_center">
				...
				<s:action name="recommend" namespace="/main" executeResult="true">
				</s:action>
				</div>
				...
				<div class="book_c_border2" id="hot">
					<s:action name="hotBook" namespace="/main" executeResult="true">
					</s:action>
				</div>
				<!--热销图书结束-->
				...
				<div class="book_c_border2" id="new">
					<s:action name="newBook" namespace="/main" executeResult="true">
				</s:action>
				</div>
					...
					<div class="book_r_b2_1x" id="new_bang">
						...
						<div id="NewProduct_1_o_t" onmouseover="">
							<h3 class="second">
								...
								<span class="more">
								<a href="../main/moreNewHotBooks.action" target="_blank">更多&gt;&gt;</a></span>
							</h3>
						</div>
					</div>
				</div>
