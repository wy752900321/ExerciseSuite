    ...
    <td width="182" valign="top">
        <div id="container">
                  ...
                  <div class="content">
                    ...
                    <ul class="MM">
                      <li><a href="/shop/categoryServlet?action=list" target="main">分类列表</a></li>
                  ...
                  <div class="content">
                    ...
                    <ul class="MM">
                      <li><a href="/shop/categoryServlet?action=list" target="main">用户列表</a></li>
                      <li><a href="addCategory.jsp" target="main">添加用户</a></li>
                    </ul>
                  </div>
