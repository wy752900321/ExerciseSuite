...
/*    public static final String getTagValue(Node n, KettleAttributeInterface code) {
     ...
     */
    public static final Document loadXMLFile(String filename) throws DGFXMLException {
        try {
            return loadXMLFile(KettleVFS.getFileObject(filename));
        } catch (Exception e) {
            throw new DGFXMLException(e);
        }
    }
     ...
     */
    public static final Document loadXMLFile(FileObject fileObject) throws DGFXMLException {
     ...
     * @return the Document if all went well, null if an error occured!
     */
    public static final Document loadXMLFile(FileObject fileObject, String systemID, boolean ignoreEntities, boolean namespaceAware) throws DGFXMLException {
        try {
            return loadXMLFile(KettleVFS.getInputStream(fileObject), systemID, ignoreEntities, namespaceAware);
        } catch (FileSystemException e) {
            throw new DGFXMLException("Unable to read file [" + fileObject.toString() + "]", e);
        } finally {
            //2013-05-28,added by jiayf , 需要将FileObject及AbstractFileSystem手工关闭。否则会出现文件被占用，无法删除问题。#ETL-92
            if (fileObject != null) {
                if (fileObject.getFileSystem() instanceof AbstractFileSystem) {
                    AbstractFileSystem fs = (AbstractFileSystem) fileObject.getFileSystem();
                    fs.close();
                }
                try {
                    fileObject.close();
     ...
     * @return the Document if all went well, null if an error occurred!
     */
    public static final Document loadXMLFile(InputStream inputStream) throws DGFXMLException {
     ...
     * @return the Document if all went well, null if an error occured!
     */
    public static final Document loadXMLFile(InputStream inputStream, String systemID, boolean ignoreEntities, boolean namespaceAware) throws DGFXMLException {
        ...
        try {
            ...
            throw new DGFXMLException("Error reading information from input stream", e);
        }
    }

    public static final Document loadXMLFile(File resource) throws DGFXMLException {
        try {
     ...
     * @return the Document if all went well, null if an error occured!
     */
    public static final Document loadXMLFile(URL resource) throws DGFXMLException {
        DocumentBuilderFactory dbf;
        DocumentBuilder db;
        Document doc;
        ...
        try {
            ...
            throw new DGFXMLException("Error reading information from resource", e);
        }
    }
     ...
     * @return the Document if all went well, null if an error occurred!
     */
    public static final Document loadXMLString(String string, Boolean namespaceAware, Boolean deferNodeExpansion) throws DGFXMLException {
        DocumentBuilderFactory dbf;
        DocumentBuilder db;
        Document doc;
        ...
        try {
            ...
            try {
                ...
                throw new DGFXMLException("Error parsing XML", ef);
            } finally {
                stringReader.close();
            }
            ...
            throw new DGFXMLException("Error reading information from XML string : " + Const.CR + string, e);
        }
    }
...
//		return addTagValue(tag, ""+l, cr);
 ...
 /*   public static final String addTagValue(KettleAttributeInterface tag, int i)
     ...
     * @throws DgfException In case there is a decoding error
     */
    public static byte[] stringToBinary(String string) throws DgfException {
        try {
            byte[] bytes;
            if (string == null) {
                bytes = new byte[]{};
            ...
            throw new DgfException("Error converting string to binary", e);
        }
    }
