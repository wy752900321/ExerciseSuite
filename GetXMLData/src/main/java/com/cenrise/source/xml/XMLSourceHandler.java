...
public class XMLSourceHandler  extends DefaultHandler{
    ...
    public XMLSourceHandler(String nodeName, List<String> tagNames, List<String> attNames)
    {
    ...
    public void startElement(String uri, String localName, String qName,
        ...
        if(attributes!=null && map!=null){
            for(int i=0;i<attributes.getLength();i++){
            	if(attNames!=null && attNames.contains(attributes.getQName(i))){
    ...
    public void characters(char[] ch, int start, int length)
        ...
        if(currentTag!=null && map!=null){
            ...
            if(currentValue!=null&&!currentValue.trim().equals("")&&!currentValue.trim().equals("\n")){
               if(tagName!=null && tagName.contains(currentTag)){
