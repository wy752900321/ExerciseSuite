...
import java.util.List;
  ...
  *
  */
 public class DGFDatabaseBatchException extends DGFDatabaseException
 {
      ...
      */
     public DGFDatabaseBatchException()
     {
         super();
     }
      ...
      */
     public DGFDatabaseBatchException(String message)
     {
         super(message);
     }
      ...
      */
     public DGFDatabaseBatchException(Throwable cause)
     {
         super(cause);
     }
      ...
      * @param cause the cause (which is saved for later retrieval by the getCause() method). (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
      */
     public DGFDatabaseBatchException(String message, Throwable cause)
     {
         super(message, cause);
     }
