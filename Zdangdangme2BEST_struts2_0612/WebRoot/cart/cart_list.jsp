		...
		<div id="div_choice" class="choice_merch">
         ...
         <s:iterator value="buyItems.{?#this.buy==true}">
						...
						<tr class='td_no_bord'>
							...
							<td>
								<a href="${pageContext.request.contextPath }/cart/DeleteCart.action?id=${pro.id}">删除</a>
							</td>
						</tr>
				...
				<div class="choice_balance">
					...
					<div class="total_balance">
						...
						<div id="balance" class="balance">
							<a name='checkout' href='${pageContext.request.contextPath}/cart/ShowOrderInfo.action' > 
				...
				<s:iterator value="deleteItems">
					<tr>
						...
						<td width="56" class=buy_td_1>
							<a href="${pageContext.request.contextPath }/cart/RecoveryCart.action?id=${pro.id}">恢复</a>
						</td>
