...
/**
 * 可以看出Druid DAO实用了DruidDataSource的工厂模式DruidDataSourceFactory，此工厂模式极大的简化了我们实用Druid的开发过程，只需通过DruidDataSourceFactory的创建方法就可以获得DataSource实例
 */
