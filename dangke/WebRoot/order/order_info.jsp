	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<s:iterator value="buyItems">
					<tr>
						...
						<td valign="top">
							<s:property value="(product.dangPrice)*count"/>
						</td>
					</tr>
			</s:iterator>
				<!-- 订单结束 -->
				<tr>
					<td valign="top" class="w1" style="text-align: left" colspan="5">
						<b><s:property value="moneyCost"/></b>
					</td>
				</tr>
			</table>
			<br />
			...
			<div class="login_in">
				...
				<a href="${pageContext.request.contextPath }/order/orderInfo.action"><input id="btnClientRegister" class="button_1" name="submit"
