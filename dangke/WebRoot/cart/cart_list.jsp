...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
					...
					<s:iterator value="buyItems">
						<s:if test="buy==true">
							<tr class='td_no_bord'>
								...
								<td>
									<a href="#"><s:property value="product.productName" />
									</a>
								</td>
								<td class="buy_td_5">
								...
								<td class="buy_td_4">
									&nbsp;&nbsp;
									<span>￥<s:property value="product.dangPrice" />
									</span>
								</td>
								<td class="buy_td_1">
									&nbsp;&nbsp;
								...
								<td>
									<input class="del_num" type="text" size="3" maxlength="4"
										id="productNum_${product.id}" />
									<a href="#" onclick="updateFun(${product.id})">变更</a>
								</td>
								<td>
									<a href="#"
										onclick='location ="cartAction!delete.action?productId=${product.id}"'>删除</a>
								</td>
							</tr>
						</s:if>
					</s:iterator>
					...
					<div class="total_balance">
						...
						<div id="balance" class="balance">
							<a name='checkout' href='#'
								onclick='location="../cart/showOrderInfo.action"'> <img
					...
					<s:iterator value="deleteItems">
						<tr>
							...
							<td width="56" class=buy_td_1>
								<a href="#"
									onclick='location="cartAction!recovery.action?productId=${product.id}"'>恢复</a>
							</td>
		...
		<center>
			<s:if test="ok==false">
				<span style="color:red" >亲！您的购物车为空，不能结算啊！.......................</span>
				<a href='../main/main.jsp' style="color:green;">请您, 继续挑选商品 &gt;&gt;</a>
			</s:if>
		</center>
		<br />
		<br />
