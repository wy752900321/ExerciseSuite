			...
			<form name="ctl00" method="post" action="register.action" id="f">
				...
				<table class="tab_login">
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="getCodeImage.action" />
							<input name="number" type="text" id="txtVerifyCode"
								class="yzm_input" />
							<div class="text_left t1">
								<p class="t1">
									<span id="vcodeValidMsg">请输入图片中的四个字母。</span>
									<a href="javascript:;" onclick='document.getElementById("imgVcode").src="getCodeImage.action?id="+Math.random()'>看不清楚？换个图片</a><br/>
