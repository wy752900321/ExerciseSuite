			...
			<DIV class=right_wai>
					...
					<DIV class=book_pic>
						<A
							...
							name=bigpicture_bk><IMG
								...
								src="../images/productImages/<s:property value="book.productPic" />" />
						</A>
					</DIV>
				...
				<DIV class=book_right>
					...
					<UL>
						<LI>
							出版时间：
							<s:property value="book.publishtime/(12*30*24*60*60*1000L)+1900" />
							年
						...
						<LI>
							印 次：11
							<s:property value="book.print_number" />
						</LI>
						<LI>
							纸 张： 胶版纸
						</LI>
						<LI>
							I S B N ：123457845457845
