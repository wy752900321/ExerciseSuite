...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/hotSaleColumn.js">
</script>
	</head>
	<body onload="hotSale();">
		&nbsp;
		...
		<div class="book">
			...
			<div class="book_center">
				...
				<div class="book_c_border2" id="hot">
					<s:action name="hotBook" namespace="/main" executeResult="true"></s:action>
				</div>
				<!--热销图书结束-->

				<!--最新上架图书开始-->
				<div class="book_c_border2" id="new">
					<s:action name="newBook" namespace="/main" executeResult="true"></s:action>
				</div>
				...
				<div class="book_r_border2" id="__XinShuReMai">
					<div class="book_r_b2_1x" id="new_bang">
						...
						<div id="NewProduct_1_o_t">
							<h3 class="second" id="hotSaleBooks">
							  <span class="dot_r"> </span>
									<span class="more"><a href="../main/moreNewHotBooks.action" target="_blank">更多&gt;&gt;</a> </span>
							</h3>
						</div>
					</div>
				</div>
