...
public class Book extends Product  implements java.io.Serializable {
    ...
    /** full constructor */
    public Book(String author, String publishing, long publishTime, String wordNumber, String whichEdtion, String totalPage, long printTime, String printNumber, String isbn, String authorSummary, String catalogue) {
        this.author = author;
        this.publishing = publishing;
        this.publishTime = publishTime;
